...
Workopia is a job listing website created during the [PHP course](https://www.udemy.com/course/php-from-scratch-course/?couponCode=KEEPLEARNING) I completed. It includes a custom Laravel-like router, controller classes, views, a database layer and a project structure using namespaces and PSR-4 autoloading. It highlights how to structure a PHP project without using any frameworks or libraries.
